<div id="sidebar" class="absolute z-1 top-0 left-0 w-64 h-full bg-white shadow-2xl transform -translate-x-full transition-transform lg:translate-x-0 lg:relative lg:w-1/4 lg:h-screen lg:fixed flex flex-col items-center justify-center p-6 rounded-r-2xl border border-gray-200">
